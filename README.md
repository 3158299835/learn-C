...
```
 **一道链式访问的例题** 
printf("%d",printf("%d",printf("%d",43)));  Find the output
This question is a test of the number of printfs returned after printing
1. The first time you print, print out 43#### 介绍
学习C语言可以联系的一些题目
...
```
 **一道链式访问的例题** 
printf("%d",printf("%d",printf("%d",43)));  //求输出
这道题考验的是 printf 打印后返回的个数
1. 第一次打印，打印出 43 返回值为 2  （个字符）
2. 第二次打印，打印出2 返回值为1
3. 第三次打印，打印出1，返回值为1
 **所以输出为 4321** 